...
* [二号基地服务器](https://2ai5229178.wicp.vip:42620), 本科生需向实验室老师和师兄(张永、程骋、马贵君)报备后使用，在Document文件夹下建立自己的文件夹并做好数据保密和文档命名分类.
* [启明学院服务器](https://24677m13k6.wicp.vip:45306)，仅硕士和博士生可用。
